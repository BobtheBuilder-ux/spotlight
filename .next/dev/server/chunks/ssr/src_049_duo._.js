...
const metadata = {
    ...
    description: 'A live pitch platform where pre-seed founders pitch to real investors, receive structured feedback, and gain exposure to potential funding opportunities.'
};
